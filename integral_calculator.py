...
class IntegralCalculator:
    ...
    def setup_ui(self):
        ...
        self.input_entry.pack(side=tk.LEFT, padx=(0, 0))
        ...
        go_btn.pack(side=tk.LEFT, padx=(0, 0))
    ...
    def create_integral_display(self):
        ...
        # Add bounds placeholders (small squares) - vertically aligned with integral symbol
    ...
    def calculate_integral(self):
        ...
        try:
            ...
            # Show result in a popup window with same styling as integral
